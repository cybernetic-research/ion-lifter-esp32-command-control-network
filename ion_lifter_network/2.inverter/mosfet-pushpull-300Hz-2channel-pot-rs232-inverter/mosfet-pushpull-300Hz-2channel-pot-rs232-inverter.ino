...
doc["sender"] = "INVERTER_PITCH";
doc["destination"] = "CONTROLLER";
doc["msg"] = "STATUS";

JsonObject payload = doc.createNestedObject("payload");
payload["ADC0"] = potVal[0];
payload["ADC1"] = potVal[1];
payload["CTRL0"] = 0;
payload["CTRL1"] = 0;
payload["REMOTE_CONTROL"] = 0;
payload["ERROR"] = 0;
...
void SerialHandler()
{
  Serial.printf("*ADC0,%u,ADC1,%u,CTRL0,%u,CTRL1,%u,REMOTE,%u,ERR,%u,\n", potVal[0],potVal[1],1,2,3,4);
}
